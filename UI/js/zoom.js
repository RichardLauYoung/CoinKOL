;(function (factory) {
    ...
    /*
    * draggable 鏄惁鏀寔妯℃€佹鎷栧姩
    * resizable 鏄惁鏀寔妯℃€佹鏀瑰彉寮圭獥澶у皬
    * movable 鏄惁鏀寔鍥剧墖鎷栧姩
    * keyboard 鏄惁鏀寔閿洏鎿嶄綔
    * title 鏄惁鏄剧ず鍥剧墖鏍囬
    * Toolbar 搴曢儴宸ュ叿閫夐」
    * i18n 涓枃璇存槑
    * callbacks 鍥炶皟鍑芥暟
    * modalSize 榛樿寮瑰眰澶у皬(width,height)
    * modalOffset 寮瑰眰鍋忕Щ閲�(x杞�,y杞�)
    * ratioThreshold 缂╂斁闃堝€�
    * dragHandle 鎷栨嫿閫夋嫨鍣�
    * */
    ...
    var defaults = {
        ...
        i18n: {
            ...
            prev: '涓婁竴寮�(鈫�)',
            next: '涓嬩竴寮�(鈫�)',
            actualSize: '瀹為檯灏哄(Ctrl+Alt+0)',
            rotateLeft: '宸︽棆杞�(Ctrl+,)',
            rotateRight: '鍙虫棆杞�(Ctrl+.)'
        },
        modalSize: [800, 600],
        modalOffset: [0, 0],
        ratioThreshold: 0.1,
            ...
            if (useIeTransforms) {
                ...
                for (var j = 0; j < _IeStyle.length; j++) {
                   ...
                   /* var imgHeightStr = currentImg[0].style.height;
                    ...
                    //杩欐牱鑾峰彇鐨勫疄闄呯殑澶у皬锛� 鏃嬭浆鍚庣浉搴旂殑瀹介珮浼氬彉
